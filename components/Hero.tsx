          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center lg:items-start gap-6">
              ...
              <a
                ...
                className="px-10 py-4 glass text-[#1D1D1F] dark:text-[#F5F5F7] rounded-full font-bold text-lg transition-all hover:bg-white dark:hover:bg-white/10 active:scale-95 flex items-center justify-center"
              >
                View Showcase
              </a>
            </div>
