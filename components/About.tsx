      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="text-[#1D1D1F]/60 dark:text-slate-400 text-lg leading-relaxed mb-10 font-medium">
            ...
            <div className="grid grid-cols-2 gap-12 border-t border-slate-100 dark:border-white/10 pt-12">
              {[
